...
Route::get('/change_language_fromline/{language}/{user_id}/{replyToken}', 'API\API_language@change_language_fromline');
...
Route::post('/api_tu_greats', 'API\API_TU_Greats@api_tu');
