...
Route::get('/change_color_partner/{color_navbar}/{name_partner}', 'API\PartnersController@change_color_partner');
...
Route::get('/search_name/{student_name_covid}/{check_in_at}','API\PartnersController@search_name');
