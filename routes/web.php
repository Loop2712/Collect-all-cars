...
Route::get('/sos_map/helper/{id_sos_map}/{organization_helper}','API\SosmapController@sos_helper');
Route::get('/sos_map/helper_after_login/{id_sos_map}/{organization_helper}','API\SosmapController@sos_helper_after_login');
