            ...
            <div class="row">
              ...
              <div class="col-12" ><br>
                <div  class="icon-boxes d-flex flex-column align-items-stretch justify-content-center ">
                    ...
                    <p class="description" style="text-indent: 30px; text-align: justify;">ใครที่อาศัยอยู่ในเขตชุมชน เช่น ตลาด ย่านการค้า หรือบ้านที่รั้วบ้านติดๆกันและมีบ้านทั้งสองฝั่งจะต้องเคยเจอมาแล้วแน่นอน วันดีคืนดีมีใครก็ไม่รู้มาจอดรถขวางหน้าบ้าน จะเอารถออกก็ไม่ได้ จะไปไหนก็ไม่ได้ จะตามตัวเจ้าของรถก็ไม่รู้จะไปตามที่ไหน ซึ่งกรณีเช่นนี้ก็เป็นประเด็นให้เห็นทางโซเชียลบ่อยครั้ง</p>
                    <br></div>
                  ...
                  <center><div class="icon"><i class="fas fa-road"></i></div>
                    ...
                    <p class="description" style="text-indent: 30px; text-align: justify;">ปัญหาที่พบได้บ่อยในย่านชุมชนเล็กๆที่ถนนเป็นแบบเลนสวน หลายคนมักจอดรถขวางเลนเพื่อลงไปซื้อของ ทำให้คันอื่นๆต้องคอยหักหลบ จนทำให้รถติด รถวิ่งลำบาก </p>
                    <br></div>
