        ...
        <div class="card radius-10 w-100">
            ...
            <div class=" p-3 mb-3">
                <div class="customers-list-item d-flex align-items-center border-top border-bottom p-2 cursor-pointer">
                    <div class="">
                        <img src="https://i.pinimg.com/originals/a7/cb/a1/a7cba17b0fa86d624e64383e8f883907.jpg" class="rounded-circle" width="46" height="46" alt="" />
                    </div>
                    <div class="ms-2">
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="d-flex align-items-center ms-auto font-13 gap-2">
                        <span class="border px-1 rounded cursor-pointer"><i class="bx bxs-circle text-primary me-1"></i>ผู้ใช้ใหม่</span>
                        <span class="border px-1 rounded cursor-pointer"><i class="bx bxs-circle text-sky-light me-1"></i>ผู้ใช้เก่า</span>
                    </div>
                </div>
