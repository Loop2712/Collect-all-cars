    ...
    <div class="accordion" id="accordion_ByCheckIn">
        <div class="card radius-10 w-100 ">
                            ...
                            <div class="dropdown ms-auto">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    @foreach ($all_data_partner as $select_area)
                                        ...
                                        @else
                                            <a class="dropdown-item" onclick="select_area_check_in('all_area')" href="javaScript:;">พื้นที่ : ทั้งหมด</a>
                                        @endif
                                    @endforeach
                                </div>
                            </div>
            ...
            <div id="area_div_checkin">
                <div class="mt-3 mb-0">
                    <h5 class="text-center font-weight-bold">พื้นที่ : ทั้งหมด</h5>
                    @php
