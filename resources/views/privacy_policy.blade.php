    ...
    <div class="container bg-white main-shadow" >
        <div class="row" style="margin: 15px ;">
            <div class="col-md-12" >
				...
				<p style="font-size: 16px; text-indent:30px;">4.2 ข้อมูลที่ผู้เข้าใช้บริการได้ลงทะเบียนสมัครสมาชิก เช่น ชื่อ, นามสกุล, หมายเลขโทรศัพท์, ไปรษณีย์อิเล็กทรอนิกส์,ข้อมูลทะเบียนยานพาหนะ, วันที่สมัครเข้าเป็นสมาชิก หรือเปลี่ยนแปลงแก้ไขข้อมูลสมาชิก รวมไปถึงรายละเอียดอื่นๆตามความจำเป็น โดยจัดเก็บเพื่อวัตถุประสงค์ในการยืนยันตัวบุคคลและป้องกันการปลอมแปลงตัวตน<br></p>
				...
				<p style="font-size: 16px; text-indent:30px;">4.5 ข้อมูลเกี่ยวกับการเข้าใช้บริการอื่น ๆ เช่นข้อมูลข้อมูลจราจรทางคอมพิวเตอร์ ฯลฯ
				...
				<p style="font-size: 16px; text-indent:30px;">6.5 ผู้เข้าใช้บริการสามารถ "ขอเปิดใช้ (Reactivate)" สถานะสมาชิกได้ ซึ่งจะทำให้สามารถเข้าถึงหน้า "ข้อมูลสมาชิก (Profile)" และ ใช้บริการได้ตามปกติ</p>
				...
				<p style="font-size: 16px; text-indent:30px;">เจ้าของข้อมูลส่วนบุคคลสามารถติดต่อในเรื่องข้อมูลส่วนบุคคลของตนเองได้ที่<br></p>
					<ol>
						...
						<li style="font-weight: 400;"><span style="font-weight: 400;">สถานที่ติดต่อ:บริษัท 2บี กรีน จำกัด เลขที่ 82/281 ถนนประชาชื่น แขวงลาดยาวเขตจตุจักร กรุงเทพมหานคร 10900</span></li>
					</ol>
			</div>
		</div>
	</div>
