    ...
    <div class="products-layout container">
        <div class="col-1-of-4">
            ...
            <form action="{{URL::to('/car')}}" method="get" >
                ...
                <div class="col">
                    <label>เลขไมค์</label>
                    <input class="form-control" type="text" name=" distancemin"  id="milemin" placeholder="น้อยสุด (km.)">
                    <input class="form-control" type="text" name=" distancemax" id="milemax" placeholder="มากสุด (km.)">
