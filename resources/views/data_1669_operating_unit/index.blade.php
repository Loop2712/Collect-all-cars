        ...
        <div class="d-flex align-items-center">
            <div class="col-12 mt-3">
                ...
                <a href="{{ url('/data_1669_operating_unit/create') }}" class="btn btn-success btn-sm float-end float-right mb-0" title="Add New Data_1669_operating_unit">
                    <i class="fa fa-plus" aria-hidden="true"></i> หน่วยแพทย์
                </a>
            </div>
        </div>
    </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <table id="example2" class="table table-striped table-bordered dataTable" role="grid" aria-describedby="example2_info">
                                    <thead>
                                        <tr role="row">
                                            <th class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 269.406px;">ชื่อ</th>
                                            <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 430.078px;">พื้นที่</th>
                                            <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="width: 198.453px;">Action</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach($data_1669_operating_unit as $item)
                                            <tr role="row" class="odd">
                                                <td class="sorting_1">{{ $item->name }} Satou</td>
                                                <td>{{ $item->area }}</td>
                                                <td>
                                                    ...
                                                    <a href="{{ url('/data_1669_operating_unit/' . $item->id . '/edit') }}" title="Edit Data_1669_operating_unit"><button class="btn btn-primary btn-sm">
                                                        <i class="fa fa-pencil-square-o" aria-hidden="true"></i> แก้ไข</button>
                                                    </a>
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <th rowspan="1" colspan="1">พื้ืนที่</th>
                                            <th rowspan="1" colspan="1">Ation</th>
                                        </tr>
                                    </tfoot>
                                </table>
                            </div>
