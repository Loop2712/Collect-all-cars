...
<div class="form-group {{ $errors->has('operating_unit_id') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="operating_unit_id" type="text" id="operating_unit_id" value="{{ isset($data_1669_operating_officer->operating_unit_id) ? $data_1669_operating_officer->operating_unit_id : ''}}" >
    {!! $errors->first('operating_unit_id', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group {{ $errors->has('user_id') ? 'has-error' : ''}}">
    <label for="user_id" class="control-label">{{ 'User Id' }}</label>
    <input class="form-control" name="user_id" type="text" id="user_id" value="{{ isset($data_1669_operating_officer->user_id) ? $data_1669_operating_officer->user_id : ''}}" >
