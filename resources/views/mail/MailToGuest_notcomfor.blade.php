        	...
        	<div  class="col-12">
        		<center>
	        		...
	        		<div class="col-11" style="border-style: solid;border-color: #ff0101;border-radius: 10px;background-color: #FAEBD7;border-width: 5px;padding: 20px;margin-top: -50px">
	        			<p style="color: #07375D;font-weight: bold;"><b>ฉันไม่สะดวก</b></p>
				...
				<h4 style="color: #FFFFFF;line-height: 2;">dd654</h4>
						...
						<center>
							<div class="col-8">
								<button type="button" style="background-color: #76d128; color:#ffffff;text-decoration: none;width: 100%;padding: 10px;border-radius: 10px;">
									<a type="button" style="background-color: #76d128; color:#ffffff;text-decoration: none;" href="tel:5">
										099
									</a>
								</button>
							</div>
