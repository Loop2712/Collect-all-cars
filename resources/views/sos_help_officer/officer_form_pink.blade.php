...
@if($idPatient !== 1)
    ...
    <form class="form mt-4 ">
                        ...
                        <div>
                            <div class="row">
                                <div class="input-group col">
                                    ...
                                    <input type="text" class="form-control border-start-0 radius-2" name="name_helper_1" value="{{ isset($data_form->name_helper) ? $data_form->name_helper : ''}}" placeholder="กรอกชื่อ" readonly>
                                </div>
                                <div class="input-group col">
        ...
        <div id="content3" class="menu-content p-3">
            <div class="col py-2">
                    ...
                    <div class="card-body">
                        ...
                        <div class="container-form-pink">
                            <div class="mr-3 container-input">
                                ...
                                <label class="m-2">
                                    <input type="radio" name="type_patient" @if($data_form->type_patient === "บาดเจ็บ/อุบัติเหตุ") checked @endif value="บาดเจ็บ/อุบัติเหตุ" class=" card-input-element d-none">
                                    <div class="card card-body d-flex flex-row justify-content-between align-items-center ">
                                        <b>
                                            บาดเจ็บ/อุบัติเหตุ
                                        </b>
                                ...
                                <label class="m-2">
                                    <input type="radio" name="type_patient" @if($data_form->type_patient === "ป่วยฉุกเฉิน") checked @endif value="ป่วยฉุกเฉิน" class=" card-input-element d-none">
                                    <div class="card card-body d-flex flex-row justify-content-between align-items-center ">
                                        <b>
                                            ป่วยฉุกเฉิน
                                        </b>
                            ...
                            <div>
                                <label for="time_of_measurement" class="form-label">เวลาในการวัด (Time)</label>
                                <div class="input-group m-2"> <span class="input-group-text bg-white radius-1"><i class="fa-solid fa-timer"></i></span>
                                    <input type="text" class="form-control border-start-0 radius-2" id="time_of_measurement" name="time_of_measurement" value="{{ isset($data_form->time_of_measurement) ? $data_form->time_of_measurement : ''}}" placeholder="Time">
                                </div>
                            </div>
                            <div>
                                <label for="vital_signs_t" class="form-label">อุณหภูมิ (T)</label>
                                <div class="input-group m-2"> <span class="input-group-text bg-white radius-1"><i class="fa-solid fa-temperature-three-quarters"></i></span>
                                    <input type="text" class="form-control border-start-0 radius-2" id="vital_signs_t" name="vital_signs_t" value="{{ isset($data_form->vital_signs_t) ? $data_form->vital_signs_t : ''}}" placeholder="กรอกอุณหภูมิ(T)">
                                </div>
                            </div>
                            <div>
                                <label for="vital_signs_bp" class="form-label">ความดันโลหิต (BP)</label>
                                <div class="input-group m-2"> <span class="input-group-text bg-white radius-1"><i class="fa-solid fa-monitor-waveform"></i></span>
                                    <input type="text" class="form-control border-start-0 radius-2" id="vital_signs_bp" name="vital_signs_bp" value="{{ isset($data_form->vital_signs_bp) ? $data_form->vital_signs_bp : ''}}" placeholder="กรอกความดันโลหิต(BP)">
                                </div>
                            </div>
                            <div>
                                <label for="vital_signs_pr" class="form-label">ชีพจร (PR)</label>
                                <div class="input-group m-2"> <span class="input-group-text bg-white radius-1"><i class="fa-solid fa-wave-pulse"></i></span>
                                    <input type="text" class="form-control border-start-0 radius-2" id="vital_signs_pr" name="vital_signs_pr" value="{{ isset($data_form->vital_signs_pr) ? $data_form->vital_signs_pr : ''}}" placeholder="กรอกชีพจร(PR)">
                                </div>
                            </div>
                            <div>
                                <label for="vital_signs_rr" class="form-label">อัตราการหายใจ (RR)</label>
                                <div class="input-group m-2"> <span class="input-group-text bg-white radius-1"><i class="fa-solid fa-head-side-cough"></i></span>
                                    <input type="text" class="form-control border-start-0 radius-2" id="vital_signs_rr" name="vital_signs_rr" value="{{ isset($data_form->vital_signs_rr) ? $data_form->vital_signs_rr : ''}}" placeholder="กรอกอัตราการหายใจ(RR)">
                                </div>
                            </div>
                            <div>
                                <label for="neuro_signs_e" class="form-label">การตอบสนองของตา (E)</label>
                                <div class="input-group m-2"> <span class="input-group-text bg-white radius-1"><i class="fa-solid fa-eye"></i></span>
                                    <input type="text" class="form-control border-start-0 radius-2" id="neuro_signs_e" name="neuro_signs_e" value="{{ isset($data_form->neuro_signs_e) ? $data_form->neuro_signs_e : ''}}" placeholder="กรอกการตอบสนองของตา(E)">
                                </div>
                            </div>
                            <div>
                                <label for="neuro_signs_v" class="form-label">การตอบสนองของเสียง (V)</label>
                                <div class="input-group m-2"> <span class="input-group-text bg-white radius-1"><i class="fa-duotone fa-messages"></i></span>
                                    <input type="text" class="form-control border-start-0 radius-2" id="neuro_signs_v" name="neuro_signs_v" value="{{ isset($data_form->neuro_signs_v) ? $data_form->neuro_signs_v : ''}}" placeholder="กรอกการตอบสนองของเสียง(V)">
                                </div>
                            </div>
                            <div>
                                <label for="neuro_signs_m" class="form-label">การตอบสนองของการเคลื่อนไหว (M)</label>
                                <div class="input-group m-2"> <span class="input-group-text bg-white radius-1"><i class="fa-solid fa-person-walking"></i></span>
                                    <input type="text" class="form-control border-start-0 radius-2" id="neuro_signs_m" name="neuro_signs_m" value="{{ isset($data_form->neuro_signs_m) ? $data_form->neuro_signs_m : ''}}" placeholder="กรอกการตอบสนองของการเคลื่อนไหว(M)">
                                </div>
                            </div>
                            <div>
                                <label for="dxt" class="form-label">การวินิจฉัย (DXT)</label>
                                <div class="input-group m-2"> <span class="input-group-text bg-white radius-1"><i class="fa-solid fa-user-doctor-message"></i></span>
                                    <input type="text" class="form-control border-start-0 radius-2" id="dxt" name="dxt" value="{{ isset($data_form->dxt) ? $data_form->dxt : ''}}" placeholder="กรอกการวินิจฉัย(DXT)">
                                </div>
                            </div>
                            ...
                            <div class="mr-3 container-input">
                                ...
                                <label class="m-2">
                                    <input type="radio" name="consciousness" @if($data_form->consciousness === "รู้สึกตัวดี") checked @endif value="รู้สึกตัวดี" class=" card-input-element d-none">
                                    <div class="card card-body d-flex flex-row justify-content-between align-items-center ">
                                        <b>
                                            รู้สึกตัวดี
                                        </b>
                                ...
                                <label class="m-2">
                                    <input type="radio" name="consciousness" @if($data_form->consciousness === "ซึม") checked @endif value="ซึม" class=" card-input-element d-none">
                                    <div class="card card-body d-flex flex-row justify-content-between align-items-center ">
                                        <b>
                                            ซึม
                                        </b>
                                ...
                                <label class="m-2">
                                    <input type="radio" name="consciousness" @if($data_form->consciousness === "หมดสติปลุกตื่น") checked @endif value="หมดสติปลุกตื่น" class=" card-input-element d-none">
                                    <div class="card card-body d-flex flex-row justify-content-between align-items-center ">
                                        <b>
                                            หมดสติปลุกตื่น
                                        </b>
                                ...
                                <label class="m-2">
                                    <input type="radio" name="consciousness" @if($data_form->consciousness === "หมดสติปลุกไม่ตื่น") checked @endif value="หมดสติปลุกไม่ตื่น" class=" card-input-element d-none">
                                    <div class="card card-body d-flex flex-row justify-content-between align-items-center ">
                                        <b>
                                            หมดสติปลุกไม่ตื่น
                                        </b>
                                ...
                                <label class="m-2">
                                    <input type="radio" name="consciousness" @if($data_form->consciousness === "แอะอะโวยวาย") checked @endif value="แอะอะโวยวาย" class=" card-input-element d-none">
                                    <div class="card card-body d-flex flex-row justify-content-between align-items-center ">
                                        <b>
                                            แอะอะโวยวาย
                                        </b>
                            ...
                            <div class="mr-3 container-input">
                                ...
                                <label class="m-2">
                                    <input type="radio" name="breathing" @if($data_form->breathing === "ปกติ") checked @endif value="ปกติ" class=" card-input-element d-none">
                                    <div class="card card-body d-flex flex-row justify-content-between align-items-center ">
                                        <b>
                                            ปกติ
                                        </b>
                                ...
                                <label class="m-2">
                                    <input type="radio" name="breathing" @if($data_form->breathing === "เร็ว") checked @endif value="เร็ว" class=" card-input-element d-none">
                                    <div class="card card-body d-flex flex-row justify-content-between align-items-center ">
                                        <b>
                                            เร็ว
                                        </b>
                                ...
                                <label class="m-2">
                                    <input type="radio" name="breathing" @if($data_form->breathing === "ช้า") checked @endif value="ช้า" class=" card-input-element d-none">
                                    <div class="card card-body d-flex flex-row justify-content-between align-items-center ">
                                        <b>
                                            ช้า
                                        </b>
                                ...
                                <label class="m-2">
                                    <input type="radio" name="breathing" @if($data_form->breathing === "ไม่สม่ำเสมอ") checked @endif value="ไม่สม่ำเสมอ" class=" card-input-element d-none">
                                    <div class="card card-body d-flex flex-row justify-content-between align-items-center ">
                                        <b>
                                            ไม่สม่ำเสมอ
                                        </b>
                                ...
                                <label class="m-2">
                                    <input type="radio" name="breathing" @if($data_form->breathing === "ไม่หายใจ") checked @endif value="ไม่หายใจ" class=" card-input-element d-none">
                                    <div class="card card-body d-flex flex-row justify-content-between align-items-center ">
                                        <b>
                                            ไม่หายใจ
                                        </b>
                            ...
                            <div class="mr-3 container-input">
                                ...
                                @endphp
                                <label class="m-2">
                                    <input type="checkbox" name="wound" @if(in_array("ไม่มี", $wound_values)) checked @endif value="ไม่มี" class=" card-input-element d-none">
                                    <div class="card card-body d-flex flex-row justify-content-between align-items-center ">
                                        <b>
                                            ไม่มี
                                        </b>
                                ...
                                <label class="m-2">
                                    <input type="checkbox" name="wound" @if(in_array("แผลถลอก", $wound_values)) checked @endif value="แผลถลอก" class=" card-input-element d-none">
                                    <div class="card card-body d-flex flex-row justify-content-between align-items-center ">
                                        <b>
                                            แผลถลอก
                                        </b>
                                ...
                                <label class="m-2">
                                    <input type="checkbox" name="wound" @if(in_array("ฉีกขาด/ตัด", $wound_values)) checked @endif value="ฉีกขาด/ตัด" class=" card-input-element d-none">
                                    <div class="card card-body d-flex flex-row justify-content-between align-items-center ">
                                        <b>
                                            ฉีกขาด/ตัด
                                        </b>
                                ...
                                <label class="m-2">
                                    <input type="checkbox" name="wound" @if(in_array("แผลฝกช้ำ", $wound_values)) checked @endif value="แผลฝกช้ำ" class=" card-input-element d-none">
                                    <div class="card card-body d-flex flex-row justify-content-between align-items-center ">
                                        <b>
                                            แผลฝกช้ำ
                                        </b>
                                ...
                                <label class="m-2">
                                    <input type="checkbox" name="wound" @if(in_array("แผลไหม้", $wound_values)) checked @endif value="แผลไหม้" class=" card-input-element d-none">
                                    <div class="card card-body d-flex flex-row justify-content-between align-items-center ">
                                        <b>
                                            แผลไหม้
                                        </b>
                                ...
                                <label class="m-2">
                                    <input type="checkbox" name="wound" @if(in_array("ถูกยิง", $wound_values)) checked @endif value="ถูกยิง" class=" card-input-element d-none">
                                    <div class="card card-body d-flex flex-row justify-content-between align-items-center ">
                                        <b>
                                            ถูกยิง
                                        </b>
                                ...
                                <label class="m-2">
                                    <input type="checkbox" name="wound" @if(in_array("ถูกแทง", $wound_values)) checked @endif value="ถูกแทง" class=" card-input-element d-none">
                                    <div class="card card-body d-flex flex-row justify-content-between align-items-center ">
                                        <b>
                                            ถูกแทง
                                        </b>
                                ...
                                <label class="m-2">
                                    <input type="checkbox" name="wound" @if(in_array("อวัยวะตัดขาด", $wound_values)) checked @endif value="อวัยวะตัดขาด" class=" card-input-element d-none">
                                    <div class="card card-body d-flex flex-row justify-content-between align-items-center ">
                                        <b>
                                            อวัยวะตัดขาด
                                        </b>
                                ...
                                <label class="m-2">
                                    <input type="checkbox" name="wound" @if(in_array("ถูกระเบิด", $wound_values)) checked @endif value="ถูกระเบิด" class=" card-input-element d-none">
                                    <div class="card card-body d-flex flex-row justify-content-between align-items-center ">
                                        <b>
                                            ถูกระเบิด
                                        </b>
                            ...
                            <div class="mr-3 container-input">
                                ...
                                <label class="m-2">
                                    <input type="radio" name="deformed_bone" @if($data_form->deformed_bone === "ไม่มี") checked @endif value="ไม่มี" class=" card-input-element d-none">
                                    <div class="card card-body d-flex flex-row justify-content-between align-items-center ">
                                        <b>
                                            ไม่มี
                                        </b>
                                ...
                                <label class="m-2">
                                    <input type="radio" name="deformed_bone" @if($data_form->deformed_bone === "ผิดรูป") checked @endif value="ผิดรูป" class=" card-input-element d-none">
                                    <div class="card card-body d-flex flex-row justify-content-between align-items-center ">
                                        <b>
                                            ผิดรูป
                                        </b>
                    ...
                    <div class="card-body">
                        ...
                        <div class="container-form-pink">
                            <div class="mr-3 container-input">
                                ...
                                @endphp
                                <label class="m-2">
                                    <input type="checkbox" name="respiratory_tract" @if(in_array("ไม่", $respiratory_tract_values)) checked @endif value="ไม่" class=" card-input-element d-none">
                                    <div class="card card-body d-flex flex-row justify-content-between align-items-center ">
                                        <b>
                                            ไม่
                                        </b>
                                ...
                                <label class="m-2">
                                    <input type="checkbox" name="respiratory_tract" @if(in_array("เปิดทางเดินหายใจ", $respiratory_tract_values)) checked @endif value="เปิดทางเดินหายใจ" class=" card-input-element d-none">
                                    <div class="card card-body d-flex flex-row justify-content-between align-items-center ">
                                        <b>
                                            เปิดทางเดินหายใจ
                                        </b>
                                ...
                                <label class="m-2">
                                    <input type="checkbox" name="respiratory_tract" @if(in_array("Pocketmask", $respiratory_tract_values)) checked @endif value="Pocketmask" class=" card-input-element d-none">
                                    <div class="card card-body d-flex flex-row justify-content-between align-items-center ">
                                        <b>
                                            Pocket Mask
                                        </b>
                            ...
                            <div class="mr-3 container-input">
                                ...
                                <label class="m-2">
                                    <input type="radio" name="wound_hemostasis" @if($data_form->wound_hemostasis === "ไม่") checked @endif value="ไม่" class=" card-input-element d-none">
                                    <div class="card card-body d-flex flex-row justify-content-between align-items-center ">
                                        <b>
                                            ไม่ได้ทำ
                                        </b>
                            ...
                            <div class="mr-3 container-input">
                                ...
                                <label class="m-2">
                                    <input type="radio" name="help_revive" @if($data_form->help_revive === "ไม่ได้ทำ") checked @endif value="ไม่ได้ทำ" class=" card-input-element d-none">
                                    <div class="card card-body d-flex flex-row justify-content-between align-items-center ">
                                        <b>
                                            ไม่ได้ทำ
                                        </b>
                                ...
                                <label class="m-2">
                                    <input type="radio" name="help_revive" @if($data_form->help_revive === "ทำ") checked @endif value="ทำ" class=" card-input-element d-none">
                                    <div class="card card-body d-flex flex-row justify-content-between align-items-center ">
                                        <b>
                                            ทำ
                                        </b>
                            ...
                            <div class="mr-3 container-input">
                                ...
                                @endphp
                                <label class="m-2">
                                    <input type="checkbox" name="bone_splint" @if(in_array("ไม่ได้ทำ", $bone_splint_values)) checked @endif value="ไม่ได้ทำ" class=" card-input-element d-none">
                                    <div class="card card-body d-flex flex-row justify-content-between align-items-center ">
                                        <b>
                                            ไม่ได้ทำ
                                        </b>
                                ...
                                <label class="m-2">
                                    <input type="checkbox" name="bone_splint" @if(in_array("เฝือกลม/ไม้ดาม", $bone_splint_values)) checked @endif value="เฝือกลม/ไม้ดาม" class=" card-input-element d-none">
                                    <div class="card card-body d-flex flex-row justify-content-between align-items-center ">
                                        <b>
                                            เฝือกลม/ไม้ดาม
                                        </b>
                                ...
                                <label class="m-2">
                                    <input type="checkbox" name="bone_splint" @if(in_array("เฝือกดามคอและกระดานรองหลังยาว", $bone_splint_values)) checked @endif value="เฝือกดามคอและกระดานรองหลังยาว" class=" card-input-element d-none">
                                    <div class="card card-body d-flex flex-row justify-content-between align-items-center ">
                                        <b>
                                ...
                                <label class="m-2">
                                    <input type="checkbox" name="bone_splint" @if(in_array("เฝือกหลังและคอ (KED)", $bone_splint_values)) checked @endif value="เฝือกหลังและคอ (KED)" class=" card-input-element d-none">
                                    <div class="card card-body d-flex flex-row justify-content-between align-items-center ">
                                        <b>
                                            เฝือกหลังและคอ (KED)
                                        </b>
                            ...
                            <div class="mr-3 container-input">
                                ...
                                @endphp
                                <label class="m-2">
                                    <input type="checkbox" name="results_of_care" @if(in_array("ไม่ยอมให้รักษา", $results_of_care_values)) checked @endif value="ไม่ยอมให้รักษา" class=" card-input-element d-none">
                                    <div class="card card-body d-flex flex-row justify-content-between align-items-center ">
                                        <b>
                                            ไม่ยอมให้รักษา
                                        </b>
        ...
        <div id="content4" class="menu-content p-3">
            <div class="col py-2">
                <div class="card radius-15">
                    <div class="card-body">
                        <h4 class="card-title">
        ...
        <div id="content5" class="menu-content p-3">
            <div class="col py-2">
                <div class="card radius-15">
                    <div class="card-body">
                        <h4 class="card-title">
        ...
        <div id="content6" class="menu-content p-3">
            <div class="col py-2">
                <div class="card radius-15">
                    <div class="card-body">
                        <h4 class="card-title">
