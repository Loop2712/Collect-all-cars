                ...
                <div class="row">
                    <div class="col-12 col-md-6">
                        ...
                        <div class="form-group {{ $errors->has('photo') ? 'has-error' : ''}}">
                            <input class="form-control" name="photo" type="file" id="photo" value="{{ isset($data->photo) ? $data->photo : ''}}" accept="image/*,application"  multiple="multiple" onchange="document.querySelector('#img_profile_old').classList.add('d-none');">
