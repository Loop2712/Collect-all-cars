                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Country</th><th>Nationality</th><th>Nationality Noun</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($nationality as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->country }}</td><td>{{ $item->nationality }}</td><td>{{ $item->nationality_noun }}</td>
                                        <td>
                            ...
                            <div class="pagination-wrapper"> {!! $nationality->appends(['search' => Request::get('search')])->render() !!} </div>
                        </div>
