...
<div style='text-align:center;margin:0; margin-top:50px'>
	<span style="font-size: 19px;font-weight: bolder;"><b>แบบบันทึกการรับแจ้งเหตุและสั่งการการแพทย์ฉุกเฉินเบื้องต้น</b></span>
</div>
<!-- {{$sos_help_center}} -->
...
<div>
	<table width="100%" style="border-spacing: -1px; font-size: 13px;">
		<tr>
	...
	<table width="100%" style="border-spacing: -1px; font-size: 13px; margin-top:1px">
		<tr style="position: fixed; right: 0mm; bottom: 0mm; rotate: 120;">
			<td class="border" width="98%">
				<table width="100%">
					<tr>
						<td width="60px"><b>ประเภทผู้ป่วย</b></td>
						<td>
		...
		<tr style="position: fixed; right: 0mm; bottom: 0mm; rotate: 120;">
			<td class="border" width="98%">
				<table width="100%">
					<tr>
						<td width="60px"><b>ทางเดินหายใจ</b></td>
						...
						<input type="radio" @if(in_array("ไม่ได้ทำ", $respiratory_tract_values)) checked="" @endif> ไม่ได้ทำ
						&nbsp;&nbsp;<input type="radio" @if(in_array("จัดท่าผู้ป่วย", $respiratory_tract_values)) checked="" @endif> จัดท่าผู้ป่วย
						&nbsp;&nbsp;<input type="radio" @if(in_array("เปิดทางเดินหายใจ", $respiratory_tract_values)) checked="" @endif> เปิดทางเดินหายใจ
						&nbsp;&nbsp;<input type="radio" @if(in_array("Pocketmask Mask", $respiratory_tract_values)) checked="" @endif> ช่วยหายใจ (Pocket Mask)
				...
				<table width="100%">
					<tr>
						<td width="60px"><b>การห้ามเลือด</b></td>
						<td>
				...
				<table width="100%">
					<tr>
						<td width="60px"><b>การดามกระดูก</b></td>
				...
				<table width="100%">
					<tr>
						<td width="60px"><b>ช่วยฟื้นคืนชีพ</b></td>
	...
	<table width="100%" style="border-spacing: -1px; font-size: 13px; margin-top:1px">
		<tr >
			...
			&nbsp;&nbsp;<input type="radio" @if(in_array("ไม่ยอมให้รักษา", $results_of_care_values)) checked="" @endif> ไม่ยอมให้รักษา
			&nbsp;&nbsp;<input type="radio" @if(in_array("ทุเลา", $results_of_care_values)) checked="" @endif> ทุเลา
			&nbsp;&nbsp;<input type="radio" @if(in_array("คงเดิม", $results_of_care_values)) checked="" @endif> คงเดิม/คงที่
	...
	<table  width="100%"   style="border-spacing:0px; font-size: 13px;">
		<tr  width="100%">
			<td style="padding-left: 5px;" colspan="2">
				<b>นำส่งห้องฉุกเฉินโรงพยาบาล</b> 
				
				<span>{{mb_strimwidth($data_form->name_hospital, 0,150, '...')}}</span> 
				<span>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;เวลา
					<!-- {{$data_form->time_go_to_hospital}} -->
					{{ thaidate("j-m-Y H:i" , strtotime($data_form->time_go_to_hospital)) }} 
				</span>
				<span>
...
<div>
	<div class="border">
		<table  width="100%" style="border-spacing:0px; font-size: 13px;">
			<tr>
				...
				<td width="200px"><b>การวินิจฉัยโรค</b>
		...
		<table  width="100%" style="border-spacing:0px; font-size: 13px;">
			<tr>
				<td style="padding-left: 5px;"> <b>ระดับการคัดแยก (ER Triage)</b>
	...
	<table class="border" width="100%" style="border-spacing:0px; font-size: 13px;margin-top:-1px">
		<tr>
			<td style="padding-left: 5px;"><b>ทางเดินหายใจ</b></td>
			<td>
		...
		<tr>
			<td style="padding-left: 5px;"><b>การห้ามเลือด</b></td>
			<td>
		...
		<tr>
			<td style="padding-left: 5px;"><b>การดามกระดูก</b></td>
			<td>
		...
		<tr>
			...
			<td style="padding-left: 5px;">
				...
				@if($data_form->role_doctor !== "แพทย์" && $data_form->role_doctor !== "พยาบาล")
					&nbsp;&nbsp;<input type="radio" checked="">ตำแหน่ง {{$data_form->role_other}}
				@endif
			</td>
		</tr>
	</table>
...
<table class="border" width="100%" style="font-size: 13px;margin-top:-1px">
	<tr>
		<!-- <td rowspan="2" width="50px"><b></b></td> -->
		<td >
			<b>Admitted</b>
...
<p align="center" class="my-0" style="font-size: 13px;margin-top: 5px	;">
