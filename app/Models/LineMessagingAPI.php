            ...
            case "mycar": 
                ...
                switch(count($car_row))
                {
                    ...
                    case "3": 
                        ...
                        $string_json = str_replace("แบนด์1", strtolower($brand[2]),$string_json);
                        $string_json = str_replace("ป้ายทะเบียน1",$registration_number[2],$string_json);
                        // พรบ
                        // เวลาปัจจุบัน
                        $date_now = date("Y-m-d "); 
                        // วันหมดอายุ พรบ
