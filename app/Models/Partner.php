...
class Partner extends Model
{
    ...
    */
     ...
     * @var array
     */
    protected $fillable = ['name', 'phone', 'line_group', 'mail','sos_area','new_sos_area','user_id_admin','color','logo','color_navbar','color_body','group_line_id','name_area','class_color_menu','type_partner','full_name','show_homepage','condo_id'];
